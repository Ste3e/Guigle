module Guigle.FileChooserSingle;
...
class FileChooser{
	...
	private uint tid;
	private string eText, sufix;
	private float[] v, c;
	private bool virgin = true;
	private enum e {ok, drives, up, bloc, scrolld, scrollu }
	...
	package static FileChooser getInstance(){
		if(instance is null){
